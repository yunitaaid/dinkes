    ...
    <section id="hero" class="hero section light-background">
      ...
      <div class="container position-relative">
        ...
        <div class="welcome position-relative" data-aos="fade-down" data-aos-delay="100">
          <h2>SELAMAT DATANG SOBAT SEHAT</h2>
          <p>Kami Akan Memfasilitasi Kesehatan Untuk Kamu GRATIS*</p>
        </div><!-- End Welcome -->

        <div class="content row gy-4">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="why-box" data-aos="zoom-out" data-aos-delay="200">
              <h3>Kenapa Harus Dinkes?</h3>
              <p>
                Halo Sobat Sehat! Nikmati berbagai layanan kesehatan gratis dari Dinas Kesehatan Kota Semarang bagi kamu yang *ber-KTP Kota Semarang.
              </p>
