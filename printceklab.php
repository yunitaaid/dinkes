    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2 style="text-align: center;">Cetak Registrasi</h2>
        </div>
        <div class="card bg-success text-white">
          <div class="card-body">Silakan Cetak Atau Screenshoot lembar di bawah ini dan tunjukkan ke Petugas Cek Lab</div>
          ...
          <div id="halamancetak" class="col-lg-12">
            <div class="custom-paper">
              ...
              <div style="padding-left: 10mm;padding-right: 10mm;">
                ...
                $peminjaman = null;
                if ($id > 0) {
                    $sql = "SELECT * FROM ceklab WHERE id = ?";
                ...
                ?>
                  ...
                  <div class="form-header">
                        <h2 style="text-align: center; font-weight: bold;">KODE REGISTRASI :  </h2>
                        <h1 style="text-align: center; font-weight: bold;">  <?php echo $peminjaman['kode']; ?></h1>
                      <table class="info-table">
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td style="width: 75%;"><?php echo $peminjaman['nama']; ?></td>
                              </tr>
                              <tr>
                                  <td style="width: 20%;">NIK</td>
                                  <td class="middle-col" style="width: 5%;">:</td>
                                  <td style="width: 75%;"><?php echo $peminjaman['nik']; ?></td>
                              </tr>
                              <tr>
                                  <td style="width: 20%;">Alamat</td>
                                  <td class="middle-col" style="width: 5%;">:</td>
                                  <td style="width: 80%;"><?php echo $peminjaman['alamat']; ?></td>
                              </tr>
                              <tr>
                                  <td style="width: 20%;">Telepon</td>
                                  <td class="middle-col" style="width: 5%;">:</td>
                                  <td style="width: 80%;"><?php echo $peminjaman['telepon']; ?></td>
                              </tr>
