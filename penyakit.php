  ...
  <main class="main">
    ...
    <section id="appointment" class="appointment section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Layanan Pencegahan dan Pengendalian Penyakit</h2>
        <p>Isi Form di Bawah ini untuk permohonan layanan</p>
      </div><!-- End Section Title -->
      
      <div class="container" data-aos="fade-up" data-aos-delay="100">

      <form action="forms/submit_penyakit.php" method="post" role="form" class="php-email-form">
        <div class="row">
           ...
           <div class="col-md-12 form-group mt-12">
            <p>Pilih Layanan :</p>
              <select name="layanan" id="layanan" class="form-select" required="">
                ...
                <option value="sosialisasi">Sosialisasi Kesehatan</option>
            ...
            <input type="tel" class="form-control" name="lokasi"  required>
            </div>
            <div class="form-group mt-12">
