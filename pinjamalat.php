...
<body class="index-page">
    ...
    <div class="branding d-flex align-items-center">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            <li><a href="/dinkes" class="active">Home<br></a></li>
  ...
  <main class="main">
    ...
    <section id="appointment" class="appointment section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Layanan Peminjaman Alat Kesehatan</h2>
        <p>Isi Form di Bawah ini untuk permohonan Peminjaman Alat </p>
      </div><!-- End Section Title -->
      
      <div class="container" data-aos="fade-up" data-aos-delay="100">

      <form action="forms/submit_alat.php" method="post" role="form" class="php-email-form">
        <div class="row">
           ...
           <label for="material-text2">Alat Yang Di Pinjam</label>
              <br>
              <div class="col-xs-6">
            ...
            <div class="col-md-12 form-group mt-12">
            <p>Pilih Akomodasi :</p>
              <select name="akomodasi" id="akomodasi" class="form-select" required="">
                <option value="">Pilih...</option>
                <option value="ambil">Di Ambil</option>
                <option value="antar">Di Antar</option>
              </select>
            </div>
            <div class="form-group mt-12">
  ...
  <script src="assets/vendor/php-email-form/validate3.js"></script>
